...
function AppHeader() {
  return (
    <AppBar position="static" sx={{ backgroundColor: (theme) => theme.palette.primary[70], height: "5rem", boxShadow: "none", borderBottom: (theme) => `1px solid ${theme.palette.primary[50]}` }}>
