        ...
        <Grid container direction="column" justifyContent="flex-start" alignItems="stretch" padding={4} spacing={2}>
          {showLeftNav ? (
            <>
              ...
              <Grid item >
                <Typography variant="h6" sx={{fontWeight:"bold"}} color={"white"}>{TEXT[language].ABOUT_US_TITLE}</Typography>
              </Grid>
              <Grid item>
                <Typography variant="subtitle1" >{TEXT[language].ABOUT_US}</Typography>
              </Grid>
              <Grid item>
                <Typography variant="h6" sx={{fontWeight:"bold"}} color={"white"}>{TEXT[language].FAQ_TITLE}</Typography>
              </Grid>
              <Grid item>
                <ul>
