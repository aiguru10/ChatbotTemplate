  ...
  return (
    <Grid container direction='column' justifyContent='center' alignItems='stretch' className='appHeight100 appHideScroll'>
      ...
      <Grid item container direction='row' justifyContent='flex-start' alignItems='stretch' className='appFixedHeight100'>
        <Grid item xs={showLeftNav ? leftNavSize : 0.5}  sx={{ backgroundColor: (theme) => theme.palette.background.chatLeftPanel, height: '100%', overflowY:"auto", display: { xs: 'none', sm: 'block' } }}>
          <LeftNav showLeftNav={showLeftNav} setLeftNav={setLeftNav} uploadedFile={uploadedFile} fileType={fileType} />
        </Grid>
        <Grid
          container
          item
          sm={showLeftNav ? chatBodySize : 11.5}
          direction='column'
          justifyContent='flex-start'
          alignItems='stretch'
          className='appHeight100'
          sx={{
            padding: { xs: '0.5rem', md: '1.5rem 5%', lg: '1.5rem 10%', xl: '1.5rem 10%' },
        ...
        >
          ...
          <Grid
            ...
            alignItems='flex-end'
            sx={{
              height: { xs: 'calc(100% - 2.625rem)', sm: 'calc(100% - 2.625rem)', md: 'calc(100% - 2.625rem)', lg: 'calc(100% - 2.625rem)', xl: 'calc(100% - 2.625rem)' },
            }}
          >
